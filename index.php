...
require_once __DIR__ . '/_partials/nav_m.php';
?>
    ...
    <div class="container">
        <div class="sixteen columns">
            ...
            <div class="categories-boxes-container">
                ...
                <!-- Box -->
                <a href="browse-jobs.php" class="category-small-box">
        ...
        <div class="eleven columns">
            <div class="padding-right">
                ...
                <div class="listings-container">
                    ...
                    <!-- Listing -->
                    <a href="job-page-alt.php" class="listing full-time">
                        <div class="listing-logo">
                            <img src="images/job-list-logo-01.png" alt="">
                        </div>
                        <div class="listing-title">
                            <h4>Marketing Coordinator - SEO / SEM Experience <span class="listing-type">Full-Time</span>
                            </h4>
                ...
                <div class="fw-carousel-review">
                    <div class="testimonial-box">
                        <div class="testimonial">Bring to the table win-win survival strategies to ensure proactive
                            ...
                            generation is on the runway heading towards a streamlined cloud content.
                        </div>
                    </div>
                    <div class="testimonial-author">
    ...
    <!-- Flip banner -->
    <a href="browse-jobs.php" class="flip-banner margin-bottom-55" data-background="images/all-categories-photo.jpg"
    ...
    <div class="container">
        ...
        <div class="one-third column">
            ...
            <div class="recent-post">
                ...
                <p>The world of job seeking can be all consuming. From secretly stalking the open reqs page of your
                    dream company to sending endless applications.</p>
        ...
        <div class="one-third column">
            ...
            <div class="recent-post">
                ...
                <p>Struggling to find your significant other the perfect Valentine’s Day gift? If I may make a
                    suggestion: woo a recruiter. </p>
                <a href="blog-single-post.html" class="button">Read More</a>
            </div>
        ...
        <div class="one-third column">
            ...
            <div class="recent-post">
                ...
                <p>If your dream employer appears on this list, you’re certainly in good company. But it also means
                    you’re up for some intense competition.</p>
                <a href="blog-single-post.html" class="button">Read More</a>
            </div>
        </div>
